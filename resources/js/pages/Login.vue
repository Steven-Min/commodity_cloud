...
<div class="flex align-items-center justify-content-center h-screen">
    <div class="surface-card p-4 shadow-2 border-round w-80 lg:w-3">
      <div class="text-center mb-5">
          <img src="/images/icons/logo.png" alt="Image" height="200" class="mb-0">
          <div class="text-900 text-3xl font-medium mb-3 font-bold">ログイン</div>
      </div>
    <div>
        <label for="email1" class="block text-900 font-medium mb-2">メールアドレス</label>
        <InputText id="email1" type="text" v-model="user.email" class="w-full mb-3" />

        <label for="password1" class="block text-900 font-medium mb-2">パスワード</label>
